...
REM Atualizado em 06/01/2020 13:58 - Versão 1.2
REM Atualizado em 13/04/2021 01:57 - Versão 1.3
REM Atualizado em 25/09/2023 14:28 - Versão 2.0 (Novo padrão de nomes de arquivos)
...
if exist "AMADO_*.mp3" (
	...
	@ren "AMADO_BATISTA_?_BLOCO_1.mp3" "Programa Amado Batista - Bloco 01.mp3" > NUL
	@ren "AMADO_BATISTA_?_BLOCO_2.mp3" "Programa Amado Batista - Bloco 02.mp3" > NUL
	@ren "AMADO_BATISTA_?_BLOCO_3.mp3" "Programa Amado Batista - Bloco 03.mp3" > NUL
	@ren "AMADO_BATISTA_?_BLOCO_4.mp3" "Programa Amado Batista - Bloco 04.mp3" > NUL
...
if exist "AS_MELHORES_DO_DIA_*.mp3" (
	...
	@ren "AS_MELHORES_DO_DIA_?_BLOCO_1.mp3" "As Melhores do Dia - Bloco 01.mp3" > NUL
	@ren "AS_MELHORES_DO_DIA_?_BLOCO_2.mp3" "As Melhores do Dia - Bloco 02.mp3" > NUL
	@ren "AS_MELHORES_DO_DIA_?_BLOCO_3.mp3" "As Melhores do Dia - Bloco 03.mp3" > NUL
	@ren "AS_MELHORES_DO_DIA_?_BLOCO_4.mp3" "As Melhores do Dia - Bloco 04.mp3" > NUL
...
if exist "CONSAGRACAO_A_NOSSA_SENHORA_*.mp3" (
	...
	@ren "CONSAGRACAO_A_NOSSA_SENHORA_?.mp3" "Milicia da Imaculada - Consagracao a Nossa Senhora.mp3" > NUL
...
if exist "MUNDO_COUNTRY_*.mp3" (
	...
	@ren "MUNDO_COUNTRY_?_BLOCO_1.mp3" "Mundo Country - Bloco 01.mp3" > NUL
	@ren "MUNDO_COUNTRY_?_BLOCO_2.mp3" "Mundo Country - Bloco 02.mp3" > NUL
	@ren "MUNDO_COUNTRY_?_BLOCO_3.mp3" "Mundo Country - Bloco 03.mp3" > NUL
	@ren "MUNDO_COUNTRY_?_BLOCO_4.mp3" "Mundo Country - Bloco 04.mp3" > NUL
...
if exist "EU_VC_E_A_JOVEM_GUARDA_*.mp3" (
	...
	@ren "EU_VC_E_A_JOVEM_GUARDA_?_BLOCO_1.mp3" "Eu Voce e a Jovem Guarda - Bloco 01.mp3" > NUL
	@ren "EU_VC_E_A_JOVEM_GUARDA_?_BLOCO_2.mp3" "Eu Voce e a Jovem Guarda - Bloco 02.mp3" > NUL
	@ren "EU_VC_E_A_JOVEM_GUARDA_?_BLOCO_3.mp3" "Eu Voce e a Jovem Guarda - Bloco 03.mp3" > NUL
	@ren "EU_VC_E_A_JOVEM_GUARDA_?_BLOCO_4.mp3" "Eu Voce e a Jovem Guarda - Bloco 04.mp3" > NUL
...
if exist "FORRO_BRASILIS_*.mp3" (
	...
	@ren "FORRO_BRASILIS_?_BLOCO_1.mp3" "Forro Brasilis - Bloco 01.mp3" > NUL
	@ren "FORRO_BRASILIS_?_BLOCO_2.mp3" "Forro Brasilis - Bloco 02.mp3" > NUL
	@ren "FORRO_BRASILIS_?_BLOCO_3.mp3" "Forro Brasilis - Bloco 03.mp3" > NUL
	@ren "FORRO_BRASILIS_?_BLOCO_4.mp3" "Forro Brasilis - Bloco 04.mp3" > NUL
...
if exist "LIGACAO_NACIONAL_*.mp3" (
	@ren "LIGACAO_NACIONAL_?_BLOCO_1.mp3" "Ligacao Nacional - Bloco 01.mp3" > NUL
	@ren "LIGACAO_NACIONAL_?_BLOCO_2.mp3" "Ligacao Nacional - Bloco 02.mp3" > NUL
	@ren "LIGACAO_NACIONAL_?_BLOCO_3.mp3" "Ligacao Nacional - Bloco 03.mp3" > NUL
	@ren "LIGACAO_NACIONAL_?_BLOCO_4.mp3" "Ligacao Nacional - Bloco 04.mp3" > NUL
...
if exist "MUNDO_SERTANEJO_*.mp3" (
	@ren "MUNDO_SERTANEJO_?_BLOCO_1.mp3" "Mundo Sertanejo - Bloco 01.mp3" > NUL
	@ren "MUNDO_SERTANEJO_?_BLOCO_2.mp3" "Mundo Sertanejo - Bloco 02.mp3" > NUL
	@ren "MUNDO_SERTANEJO_?_BLOCO_3.mp3" "Mundo Sertanejo - Bloco 03.mp3" > NUL
	@ren "MUNDO_SERTANEJO_?_BLOCO_4.mp3" "Mundo Sertanejo - Bloco 04.mp3" > NUL
...
if exist "PALAVRAS_DE_FE_*.mp3" (
	...
	@ren "PALAVRAS_DE_FE_?.mp3" "Frei Gilvander Moreira - Palavras de Fe.mp3" > NUL
...
if exist "RADIO_ESCUTA_*.mp3" (
	...
	@ren "RADIO_ESCUTA_?_BLOCO_1.mp3" "Radio Escuta - Bloco 01.mp3" > NUL
	@ren "RADIO_ESCUTA_?_BLOCO_2.mp3" "Radio Escuta - Bloco 02.mp3" > NUL
	@ren "RADIO_ESCUTA_?_BLOCO_3.mp3" "Radio Escuta - Bloco 03.mp3" > NUL
	@ren "RADIO_ESCUTA_?_BLOCO_4.mp3" "Radio Escuta - Bloco 04.mp3" > NUL
...
if exist "ROBERTO_CARLOS_E_COMPANHIA_*.mp3" (
	...
	@ren "ROBERTO_CARLOS_E_COMPANHIA_?_BLOCO_1.mp3" "Roberto Carlos e Companhia - Bloco 01.mp3" > NUL
	@ren "ROBERTO_CARLOS_E_COMPANHIA_?_BLOCO_2.mp3" "Roberto Carlos e Companhia - Bloco 02.mp3" > NUL
	@ren "ROBERTO_CARLOS_E_COMPANHIA_?_BLOCO_3.mp3" "Roberto Carlos e Companhia - Bloco 03.mp3" > NUL
	@ren "ROBERTO_CARLOS_E_COMPANHIA_?_BLOCO_4.mp3" "Roberto Carlos e Companhia - Bloco 04.mp3" > NUL
...
if exist "SAUDE_COM_BELEZA_*.mp3" (
	...
	@ren "SAUDE_COM_BELEZA_?_BLOCO_1.mp3" "Saude com Beleza - Bloco 01.mp3" > NUL
	@ren "SAUDE_COM_BELEZA_?_BLOCO_2.mp3" "Saude com Beleza - Bloco 02.mp3" > NUL
	@ren "SAUDE_COM_BELEZA_?_BLOCO_3.mp3" "Saude com Beleza - Bloco 03.mp3" > NUL
	@ren "SAUDE_COM_BELEZA_?_BLOCO_4.mp3" "Saude com Beleza - Bloco 04.mp3" > NUL
...
if exist "VIVENDO_COM_OTIMISMO_*.mp3" (
	...
	@ren "VIVENDO_COM_OTIMISMO_?.mp3" "Vivendo com Otimismo - Bloco 01.mp3" > NUL

	@mkdir "Radio Estudio Brasil - Vivendo com Otimismo"
	del ".\Radio Estudio Brasil - Vivendo com Otimismo\*.mp3" /S /Q > NUL
	move "Vivendo com Otimismo*.mp3" ".\Radio Estudio Brasil - Vivendo com Otimismo" > NUL
...
if exist "MEDITACAO_DO_DIA_*.mp3" (
	...
	@ren "MEDITACAO_DO_DIA_?.mp3" "Meditacao do Dia - Bloco 01.mp3" > NUL
...
if exist "SERTAO_SAUDADE_*.mp3" (
	...
	@ren "SERTAO_SAUDADE_?_BLOCO_1.mp3" "Sertao Saudade - Bloco 01.mp3" > NUL
	@ren "SERTAO_SAUDADE_?_BLOCO_2.mp3" "Sertao Saudade - Bloco 02.mp3" > NUL
	@ren "SERTAO_SAUDADE_?_BLOCO_3.mp3" "Sertao Saudade - Bloco 03.mp3" > NUL
	@ren "SERTAO_SAUDADE_?_BLOCO_4.mp3" "Sertao Saudade - Bloco 04.mp3" > NUL
...
if exist "CAMINHANDO_COM_JESUS_CRISTO_*.mp3" (

	@ren "CAMINHANDO_COM_JESUS_CRISTO_?_BLOCO_1.mp3" "Caminhando com Jesus Cristo - Bloco 01.mp3" > NUL
	@ren "CAMINHANDO_COM_JESUS_CRISTO_?_BLOCO_2.mp3" "Caminhando com Jesus Cristo - Bloco 02.mp3" > NUL
...
if not exist "CLUBE_DO_CAIPIRAO_???_%1_*.zip" goto SKIP17
echo.
echo ==========================================================
echo 17. Radio Estudio Brasil - Clube do Caipirão

7z e -y "CLUBE_DO_CAIPIRAO_???_%1_*.zip"
if exist "CLUBE_DO_CAIPIRAO_*.mp3" (

	@ren "CLUBE_DO_CAIPIRAO_?_BLOCO_1.mp3" "Clube do Caipirao - Bloco 01.mp3" > NUL
	@ren "CLUBE_DO_CAIPIRAO_?_BLOCO_2.mp3" "Clube do Caipirao - Bloco 02.mp3" > NUL
	@ren "CLUBE_DO_CAIPIRAO_?_BLOCO_3.mp3" "Clube do Caipirao - Bloco 03.mp3" > NUL
	@ren "CLUBE_DO_CAIPIRAO_?_BLOCO_4.mp3" "Clube do Caipirao - Bloco 04.mp3" > NUL
	@ren "CLUBE_DO_CAIPIRAO_?_BLOCO_5.mp3" "Clube do Caipirao - Bloco 05.mp3" > NUL
	@ren "CLUBE_DO_CAIPIRAO_?_BLOCO_6.mp3" "Clube do Caipirao - Bloco 06.mp3" > NUL
	
	@mkdir "Radio Estudio Brasil - Clube do Caipirao"
	del ".\Radio Estudio Brasil - Clube do Caipirao\*.mp3" /S /Q > NUL
	move "Clube do Caipirao*.mp3" ".\Radio Estudio Brasil - Clube do Caipirao" > NUL

	move "CLUBE_DO_CAIPIRAO_???_%1_*.zip" ".\Lixeira" > NUL
)
:SKIP17
...
if exist "BRASIL_BREGA_SHOW_*.mp3" (
	...
	@ren "BRASIL_BREGA_SHOW_BLOCO_1.mp3" "Brasil Brega Show - Bloco 01.mp3" > NUL
	@ren "BRASIL_BREGA_SHOW_BLOCO_2.mp3" "Brasil Brega Show - Bloco 02.mp3" > NUL
	@ren "BRASIL_BREGA_SHOW_BLOCO_3.mp3" "Brasil Brega Show - Bloco 03.mp3" > NUL
	@ren "BRASIL_BREGA_SHOW_BLOCO_4.mp3" "Brasil Brega Show - Bloco 04.mp3" > NUL
...
if exist "ENCONTRO_COM_ARI_SANTOS_*.mp3" (
	...
	@ren "ENCONTRO_COM_ARI_SANTOS_BLOCO_1.mp3" "Encontro com Ari Santos - Bloco 01.mp3" > NUL
	@ren "ENCONTRO_COM_ARI_SANTOS_BLOCO_2.mp3" "Encontro com Ari Santos - Bloco 02.mp3" > NUL
	@ren "ENCONTRO_COM_ARI_SANTOS_BLOCO_3.mp3" "Encontro com Ari Santos - Bloco 03.mp3" > NUL
	@ren "ENCONTRO_COM_ARI_SANTOS_BLOCO_4.mp3" "Encontro com Ari Santos - Bloco 04.mp3" > NUL
...
if exist "LUIZ_GONZAGA_O_REI_DO_BAIAO_*.mp3" (
	...
	@ren "LUIZ_GONZAGA_O_REI_DO_BAIAO_BLOCO_1.mp3" "Luiz Gonzaga O Rei do Baiao - Bloco 01.mp3" > NUL
	@ren "LUIZ_GONZAGA_O_REI_DO_BAIAO_BLOCO_2.mp3" "Luiz Gonzaga O Rei do Baiao - Bloco 02.mp3" > NUL
	@ren "LUIZ_GONZAGA_O_REI_DO_BAIAO_BLOCO_3.mp3" "Luiz Gonzaga O Rei do Baiao - Bloco 03.mp3" > NUL
	@ren "LUIZ_GONZAGA_O_REI_DO_BAIAO_BLOCO_4.mp3" "Luiz Gonzaga O Rei do Baiao - Bloco 04.mp3" > NUL
...
if exist "SEMPRE_AMIGOS_*.mp3" (
	...
	@ren "SEMPRE_AMIGOS_BLOCO_1.mp3" "Sempre Amigos - Bloco 01.mp3" > NUL
	@ren "SEMPRE_AMIGOS_BLOCO_2.mp3" "Sempre Amigos - Bloco 02.mp3" > NUL
	@ren "SEMPRE_AMIGOS_BLOCO_3.mp3" "Sempre Amigos - Bloco 03.mp3" > NUL
	@ren "SEMPRE_AMIGOS_BLOCO_4.mp3" "Sempre Amigos - Bloco 04.mp3" > NUL
	@ren "SEMPRE_AMIGOS_BLOCO_5.mp3" "Sempre Amigos - Bloco 05.mp3" > NUL
	@ren "SEMPRE_AMIGOS_BLOCO_6.mp3" "Sempre Amigos - Bloco 06.mp3" > NUL
	@ren "SEMPRE_AMIGOS_BLOCO_7.mp3" "Sempre Amigos - Bloco 07.mp3" > NUL
	@ren "SEMPRE_AMIGOS_BLOCO_8.mp3" "Sempre Amigos - Bloco 08.mp3" > NUL
...
if exist "ROBERTO_E_MEIRINHO_*.mp3" (
	...
	@ren "ROBERTO_E_MEIRINHO_BLOCO_1.mp3" "Roberto e Meirinho - Bloco 01.mp3" > NUL
	@ren "ROBERTO_E_MEIRINHO_BLOCO_2.mp3" "Roberto e Meirinho - Bloco 02.mp3" > NUL
	@ren "ROBERTO_E_MEIRINHO_BLOCO_3.mp3" "Roberto e Meirinho - Bloco 03.mp3" > NUL
	@ren "ROBERTO_E_MEIRINHO_BLOCO_4.mp3" "Roberto e Meirinho - Bloco 04.mp3" > NUL
	@ren "ROBERTO_E_MEIRINHO_BLOCO_5.mp3" "Roberto e Meirinho - Bloco 05.mp3" > NUL
	@ren "ROBERTO_E_MEIRINHO_BLOCO_6.mp3" "Roberto e Meirinho - Bloco 06.mp3" > NUL
	@ren "ROBERTO_E_MEIRINHO_BLOCO_7.mp3" "Roberto e Meirinho - Bloco 07.mp3" > NUL
	@ren "ROBERTO_E_MEIRINHO_BLOCO_8.mp3" "Roberto e Meirinho - Bloco 08.mp3" > NUL
...
if exist "BAXA_AGUIA_*.mp3" (
	...
	@ren "BAXA_AGUIA_BLOCO_1.mp3" "Baxa Aguia Que A Moda E Muito Boa - Bloco 01.mp3" > NUL
	@ren "BAXA_AGUIA_BLOCO_2.mp3" "Baxa Aguia Que A Moda E Muito Boa - Bloco 02.mp3" > NUL
	@ren "BAXA_AGUIA_BLOCO_3.mp3" "Baxa Aguia Que A Moda E Muito Boa - Bloco 03.mp3" > NUL
	@ren "BAXA_AGUIA_BLOCO_4.mp3" "Baxa Aguia Que A Moda E Muito Boa - Bloco 04.mp3" > NUL
	@ren "BAXA_AGUIA_BLOCO_5.mp3" "Baxa Aguia Que A Moda E Muito Boa - Bloco 05.mp3" > NUL
	@ren "BAXA_AGUIA_BLOCO_6.mp3" "Baxa Aguia Que A Moda E Muito Boa - Bloco 06.mp3" > NUL
	@ren "BAXA_AGUIA_BLOCO_7.mp3" "Baxa Aguia Que A Moda E Muito Boa - Bloco 07.mp3" > NUL
	@ren "BAXA_AGUIA_BLOCO_8.mp3" "Baxa Aguia Que A Moda E Muito Boa - Bloco 08.mp3" > NUL
...
if exist "AS_CAMPEAS_DA_SEMANA_*.mp3" (
	...
	@ren "AS_CAMPEAS_DA_SEMANA_BLOCO_1.mp3" "As Campeas da Semana - Bloco 01.mp3" > NUL
	@ren "AS_CAMPEAS_DA_SEMANA_BLOCO_2.mp3" "As Campeas da Semana - Bloco 02.mp3" > NUL
	@ren "AS_CAMPEAS_DA_SEMANA_BLOCO_3.mp3" "As Campeas da Semana - Bloco 03.mp3" > NUL
	@ren "AS_CAMPEAS_DA_SEMANA_BLOCO_4.mp3" "As Campeas da Semana - Bloco 04.mp3" > NUL
	@ren "AS_CAMPEAS_DA_SEMANA_BLOCO_5.mp3" "As Campeas da Semana - Bloco 05.mp3" > NUL
	@ren "AS_CAMPEAS_DA_SEMANA_BLOCO_6.mp3" "As Campeas da Semana - Bloco 06.mp3" > NUL
	@ren "AS_CAMPEAS_DA_SEMANA_BLOCO_7.mp3" "As Campeas da Semana - Bloco 07.mp3" > NUL
	@ren "AS_CAMPEAS_DA_SEMANA_BLOCO_8.mp3" "As Campeas da Semana - Bloco 08.mp3" > NUL
